...
def alg_R0(nodes, dic) :
    ...
    degree, node_degree_0, _, _ = get_degree(nodes, dic, True, False, False)
    if node_degree_0 != -1 :    # If a nodes has degree 0
        nodes.remove(node_degree_0)
        size, nbr_rec_call = alg_R0(nodes, dic)
    ...
    size_1, nbr_rec_call_1 = alg_R0(nodes_without_neighbors, dic) 
    size_2, nbr_rec_call_2 = alg_R0(nodes, dic)
...
def main() :
    ...
    max_size, rec_calls = alg_R0(nodes, dic)
